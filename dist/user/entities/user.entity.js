...
let User = class User {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, username: { required: true, type: () => String }, password: { required: true, type: () => String }, phone: { required: true, type: () => String }, fullName: { required: true, type: () => String }, age: { required: true, type: () => Number }, avatar: { required: true, type: () => String }, is_admin: { required: true, type: () => Boolean }, room: { required: true, type: () => require("../../room/entities/room.entity").Room }, bannedRooms: { required: true, type: () => [require("../../room/entities/room.entity").Room] }, messages: { required: true, type: () => [require("../../room/entities/message.entity").Message] } };
    }
};
__decorate([
